...
<head>
    ...
    <link rel="stylesheet" href="asset/login-clean.css">
...
<body>
    <div>
        <nav class="navbar navbar-default" role="navigation">
            ...
            <h5 class="navbar-brand">SPK PEMILIHAN TUMBUHAN HUTAN BERKHASIAT OBAT UNTUK PENYAKIT SIRKULASI DARAH</h5>
            </div>
        </nav>
    </div>
    ...
    <div class="login-clean">
        <form method="post" action="login-proses.php">
           ...
           <div class="illustration"><img src="gambar/pohon.svg" class="img-responsive img-circle" > </div>
            ...
            <div class="form-group"><button class="btn btn-warning btn-block" type="submit">Log In</button></div></form>
    </div>
